...
// Test the byteOffset and length arguments
{
  (function () {
    ...
    ab[3] = 4;
    ab[4] = 5;
    var buf = bufferShim.from(ab.buffer, 1, 3);
    ...
    assert.throws(function () {
      return bufferShim.from(ab.buffer, 6);
    }, function (err) {
    ...
    assert.throws(function () {
      return bufferShim.from(ab.buffer, 3, 6);
    }, function (err) {
      assert(err instanceof RangeError);
